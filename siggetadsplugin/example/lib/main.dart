...
class _MyAppState extends State<MyApp> {
  ...
  final _siggetadspluginPlugin = Siggetadsplugin();

  @override
  void initState() {
    super.initState();
    // initPlatformState();
    initSigAdsFindManager();
  }
  ...
  Future<void> initSigAdsFindManager() async {
    ...
    try {
      map = await SigAdsFindManager.getAdKeyword();
    } on PlatformException {
      map = {"campaignId":"错误的id"};
    }

    setState(() {
      _platformVersion = map['campaignId'].toString();
    });
  }
